...
class BacteriaGrowth(Rule):
    def __init__(self, geometry, time_step : float, bacteria_keys, substrate_key, Yca, base_prob):
    ...
    def apply_state(self, state):
        ...
        growth_prob = np.clip(self.Yca * self.base_prob * substrate_count, 0.0, 1.0)
